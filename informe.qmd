...
Una vez más, bajo la restricción \textit{costo computacional-precisión} podemos encontrar un método intermedio entre aplicar la versión mas pura de la inferencia conformal y la versión donde introducimos divisiones en la muestra, es el conocido método de \textit{Jackkinfe}.
